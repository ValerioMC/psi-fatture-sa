 ...
 *
 * The test environment accepts only the public user of the Sogei kit, so
 * there it can be filled in with one click.
 */
...
import type { TsConnectionCheck, TsCredentialsStatus, TsEnvironment, TsSettings } from '@/types'
